...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 4
    actual = count_negatives((12, -4, -3, 9, 10, -1, 8, 8, -11, 0))
    print()
    ...
    # Test 7:
    expected = 7
    actual = count_negatives((-5, -10, -6, -20, -15, 7, -55, 3, -2.5))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 3
    seq = [[2, 5], [5, 1, 1, 1], [7], [7, 5, 10, 1, 1, 1], [11, 243], [9, 81, 19, 12]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 7
    seq = [[0], [13, 4], [8, 8, 8, 8], [43], [11, 243], [55, 3], [100], [73, 84, 95], [101, 102]]
    actual = count_short_ones(seq)
    print()
